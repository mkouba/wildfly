...
public class ServiceLoaders {
     ...
     * @return
     */
    public static Map<Class<? extends Service>, Service> loadModuleServices(Class<?> clazz, DeploymentUnit rootDeploymentUnit, DeploymentUnit deploymentUnit,
            Module module, ResourceRoot resourceRoot) {
        ServiceLoader<ModuleServicesProvider> serviceLoader = ServiceLoader.load(ModuleServicesProvider.class,
                WildFlySecurityManager.getClassLoaderPrivileged(clazz));
        return loadModuleServices(serviceLoader, rootDeploymentUnit, deploymentUnit, module, resourceRoot);
    }
