...
public class BeanArchiveProcessor implements DeploymentUnitProcessor {
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        // TODO moved JaxwsInjectionServices registration to WeldDeploymentProcessor
        ...
        // for (Entry<Class<? extends Service>, Service> entry : ServiceLoaders.loadModuleServices(BeanArchiveProcessor.class, deploymentUnit).entrySet()) {
